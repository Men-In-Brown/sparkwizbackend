...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedOrigins("https://nighthawkcoders.github.io", "https://sparkwizards.github.io", "http://localhost:4000", "http://127.0.0.1:4100", "http://127.0.0.1:4100/spark/create-account").allowedMethods("GET", "POST","PUT", "DELETE");
    }
